...
// $("#myModal").modal('hide');
    ...
    function initThePage(results){
        ...
        $(".infoPart").find("tbody").append(
            "<tr class='info'><td align='center'>"+results.id+"</td><td align='center'>"+results.name+"</td><td align='center'>"+results.sex+"</td><td align='center'>"+results.age+"</td><td align='center'>"+results.title+"</td><td align='center'>"+getLocalTime(results.admissionTime).substring(0,10)+"</td><td align='center'>"+results.scientificResearchScore+"</td><td align='center'>"+results.teachingResearchScore+"</td><td align='center'><button type='button' class='btn btn-warning btnEdit' data-toggle='modal' data-target='#see'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> 查看详情</button> <button type='button' class='btn btn-warning' data-toggle='modal' data-target='#editPassword' id='clickEditPassword'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> 修改密码</button> </td></tr>");
